...
//Extending Uint256 with SafeMath Library. using SafeMath for uint256;
    ...
    function transfer(address recipient, uint256 amount) public virtual  override returns (bool) {
        ...
        require(block.timestamp == block.timestamp+10 days,"you can not transfer token before 10 days");
